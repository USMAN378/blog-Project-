...
import { getSinglePost ,getPosts } from '../actions/generalActions';
import axios from 'axios';
 ...
 class MainPage extends Component {
  ...
  componentDidMount(){
      ...
      const check = this.props.location.postId;
      this.props.getPosts();
...
export default connect(mapStateToProps,{getPosts,getSinglePost})(MainPage);